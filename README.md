...
This is the code base for ANLP HUJI course exercise 1, fine tuning a pretrained model (bert-base-uncased) to perform the paraphrase detection task on the MRPC dataset from the GLUE benchmark.
